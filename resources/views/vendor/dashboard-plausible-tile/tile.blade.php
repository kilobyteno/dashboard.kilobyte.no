            ...
            @foreach($data as $key => $value)
                <div>
                    <div class="text-lg inline-block align-bottom">
                        ...
                        <span
                            class="inline-block text-xs text-gray-600 dark:text-gray-700">{{ $value['realtime_visitors'] ? $value['realtime_visitors'] . ' ' . trans_choice('{1} current visitor|[*]current visitors', $value['realtime_visitors']) : 'N/A' }}</span>
                    </span>
                    </div>
                    <div class="grid grid-rows-2 grid-cols-2 gap-4 text-lg leading-none">
                        <div>
                            ...
                            {{ $value['bounce_rate'] ? $value['bounce_rate'] . '%' : 'N/A' }}
                        </div>
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline-block" fill="none"
                                 viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        ...
                        <div>
                            ...
                            {{ $value['visit_duration'] ? $value['visit_duration'] . 's' : 'N/A' }}
                        </div>
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline-block" fill="none"
                                 viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
