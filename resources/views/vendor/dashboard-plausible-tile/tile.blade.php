            ...
            @foreach($data as $key => $value)
                <div>
                    <div class="text-lg inline-block align-bottom">
                        ...
                        <span class="block">
                        <svg class="inline-block w-1 mr-0.5 {{ ($value['realtime_visitors'] > 0) ? 'text-green-500' : 'text-gray-300' }} fill-current" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><circle cx="8" cy="8" r="8"></circle></svg>
                        <span class="inline-block text-xs text-gray-600 dark:text-gray-700">{{ $value['realtime_visitors'] }} {{ trans_choice('{1} current visitor|[*]current visitors', $value['realtime_visitors']) }}</span>
                    </span>
                    </div>
